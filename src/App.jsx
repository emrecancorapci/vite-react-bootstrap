        ...
        <main>
          ...
          <div className="row g-5">
            ...
            <div className="col-md-6">
              ...
              <ul className="list-unstyled ps-0">
                <li>
                  <a className="icon-link mb-1" href="../getting-started/introduction/">
                    <svg className="bi" width="16" height="16">
                      <use xlinkHref="#arrow-right-circle" />
                    </svg>
                ...
                <li>
                  <a className="icon-link mb-1" href="../getting-started/webpack/">
                    <svg className="bi" width="16" height="16">
                      <use xlinkHref="#arrow-right-circle" />
                    </svg>
                ...
                <li>
                  <a className="icon-link mb-1" href="../getting-started/parcel/">
                    <svg className="bi" width="16" height="16">
                      <use xlinkHref="#arrow-right-circle" />
                    </svg>
                ...
                <li>
                  <a className="icon-link mb-1" href="../getting-started/contribute/">
                    <svg className="bi" width="16" height="16">
                      <use xlinkHref="#arrow-right-circle" />
                    </svg>
